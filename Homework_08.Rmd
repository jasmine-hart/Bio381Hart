...
# there is more variation at the middle rate because of natural variation and possible nutrient leaching
plantdata1 <- data.frame(lowN,medN,highN)
plantdata1 %>%
...
# to get a p-value of >0.05 i hadt to put all of the means between 20-22, and that resulted in a p  value of 0.076, making it in significant.
```
